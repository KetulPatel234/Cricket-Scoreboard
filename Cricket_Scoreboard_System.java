...
class Innings
{
    ...
    void startInnings() {
        ...
        System.out.println("Enter player number of " + bowlingTeam.teamName + " who is bowling.\nEnter from given list below:");
            ...
            while (checkInput) {
                    ...
                    case "7":
                        ...
                        if(bowlingTeam.teamWickets<10)
                        {
                            ...
                            while(!match)
                            {
                                ...
                                for(int j=0;j<battingTeam.teamPlayers.length;j++)
                                {
                                    if(check0 ==(battingTeam.teamPlayers[j].playerID)&&!battingTeam.teamPlayers[j].batted)
                                    {
                        ...
                        {
                            endInnings=true;
                            System.out.println("End of the Innings here,the score is  ->> "+ battingTeam.teamRuns + "/" + bowlingTeam.teamWickets);
                        }
                ...
                if (balls == 7) {
                    ...
                    if (oversCompleted != overs) {
                        System.out.println("Score after " + oversCompleted + " overs ->> " + battingTeam.teamRuns + "/" + bowlingTeam.teamWickets);
                        System.out.println("Enter new bowler number from the given list below:\nDon't select a bowler who bowled last over.");
                        boolean check = true;
                        while (check) {
                            bowler = checkPlayer(bowlingTeam);
                            if (bowler.oversBowled == bowlerMaxOvers) {
                                System.out.println("\nBowler - " + bowler.playerName + " has already bowled " + bowlerMaxOvers + " over/s" +
    ...
    void calculateScore()
    {
        ...
        {
            battingTeam.teamPlayers[i].playerStrikeRate=battingTeam.teamPlayers[i].playerRuns/(double)battingTeam.teamPlayers[i].playerBallsPlayed*100;
            if(bowlingTeam.teamPlayers[i].oversBowled==0)
            {
                bowlingTeam.teamPlayers[i].playerEconomy= Double.NaN;
            }
            else
                bowlingTeam.teamPlayers[i].playerEconomy=bowlingTeam.teamPlayers[i].gotRuns/(double) bowlingTeam.teamPlayers[i].oversBowled;
        }
    }
    //------------------------------------------------------------------------------------
    ...
    void displayWinnerTeam(Innings i1,Innings  i2)
    {
        ...
        {
            System.out.println("\n\t\t\t\t====================== WINNER TEAM ======================\n");
            System.out.println("\t\t\t\tWinner Team is \""+battingTeam.teamName+"\" and they won by "+(10-bowlingTeam.teamWickets)+" wickets.\n");
            System.out.println("\t\t\t\t=========================================================\n");
        }
        else if(winnerTeam==bowlingTeam)
        {
            System.out.println("\n\t\t\t\t====================== WINNER TEAM ======================\n");
            System.out.println("\t\t\t\tWinner Team is \""+bowlingTeam.teamName+"\" and they won by "+(bowlingTeam.teamRuns-battingTeam.teamRuns)+" wickets.\n");
            System.out.println("\t\t\t\t=========================================================\n");
        }
        else
        {
                ...
                while(!exitDisplayScore)
                {
                    ...
                    switch(inningsChoice)
                    {
                        case "1":
                            ...
                            {
                                System.out.println("Which of the following scores you want for Innings-1 , Enter number accordingly." +
                                        "\n1 ->> Overall Score\n2 ->> Batting team Score\n3 ->> Bowling team Score\n4 ->> All of the above" +
                        ...
                        case "2":
                            ...
                            {
                                System.out.println("Which of the following scores you want for Innings-2 , Enter number accordingly." +
                                        "\n1 ->> Overall Score\n2 ->> Batting team Score\n3 ->> Bowling team Score\n4 ->> All of the above" +
